    ...
    <div style={{ width: '100%', height: '100%', background: 'radial-gradient(circle at 50% 45%, #17151a 0%, #09090B 62%)', display: 'grid', placeItems: 'center', overflow: 'hidden' }}>
      <svg viewBox="0 0 900 620" role="img" aria-label="S-Style Electric finish preview" style={{ width: isZoomed ? 'min(102%, 980px)' : 'min(88%, 900px)', height: isZoomed ? 'min(96%, 660px)' : 'min(86%, 620px)', transform: isZoomed ? 'translateY(18px) scale(1.08)' : 'translateY(2px)', transition: 'transform 280ms ease, width 280ms ease, height 280ms ease', filter: 'drop-shadow(0 30px 68px rgba(0,0,0,0.52))' }}>
        ...
        <g transform="translate(112 16) rotate(-8 360 302)">
          ...
          <g data-part="body">
            <path
              d="M384 245 C361 198 311 193 284 232 C270 252 271 275 290 293 C247 295 211 322 197 364 C178 421 213 477 272 497 C322 514 367 496 391 459 C415 499 480 500 530 456 C574 417 584 354 550 310 C529 284 506 274 478 273 C506 243 495 204 458 202 C424 200 402 220 384 245 Z"
              fill="#EEE7D6"
              stroke="#D8C89E"
              strokeWidth="16"
              strokeLinejoin="round"
            ...
            />
            <path
              d="M294 318 C268 324 239 346 229 381 C215 430 247 470 291 482 C333 494 366 477 388 443 C414 478 469 480 512 443 C552 408 561 354 529 319 C512 301 487 292 455 292 C479 263 469 229 440 224 C411 219 390 238 373 268 C350 233 315 230 297 257 C285 275 287 299 304 314 Z"
              fill="url(#sStyleBodyGloss)"
              opacity="0.62"
            />
            <path d="M484 274 C524 295 552 337 547 383 C562 344 549 309 525 289 C508 275 494 269 484 274 Z" fill="rgba(0,0,0,0.14)" />
          </g>

          <g data-part="pickguard">
            <path
              d="M337 264 C363 245 395 244 421 264 C445 282 472 294 512 291 C534 311 541 345 526 378 C508 417 466 431 424 415 C393 403 372 379 346 369 C324 361 305 369 292 386 C283 359 287 319 307 292 C316 280 325 271 337 264 Z"
              fill="#F2EEE2"
              stroke="#D7D0C2"
              strokeWidth="5"
              strokeLinejoin="round"
            />
            <path d="M340 274 C377 256 406 263 432 283 C457 302 486 308 516 301" fill="none" stroke="rgba(255,255,255,0.55)" strokeWidth="2" />
          </g>
