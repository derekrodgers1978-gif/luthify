  ...
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative' }}>
      {webglStatus === 'supported' ? (
        ...
        <div style={{ width: '100%', height: '100%', background: 'radial-gradient(circle at 50% 45%, #17151a 0%, #09090B 62%)', display: 'grid', placeItems: 'center', color: '#F2EEE2', textAlign: 'center', padding: 24 }}>
          <div>
            <p style={{ margin: 0, color: '#C9A45C', fontSize: '0.75rem', fontWeight: 700, letterSpacing: '0.12em', textTransform: 'uppercase' }}>
              Guitar preview unavailable
            </p>
            <p style={{ margin: '10px 0 0', maxWidth: 360, lineHeight: 1.5 }}>
              {webglStatus === 'checking' ? 'Checking WebGL support...' : 'WebGL is not supported or is unavailable in this browser.'}
            </p>
          </div>
        </div>
      )}
